...
Strategy students have the option to align with 1 of 4 tracks, each leading to a different experiential learning experience and likely career outcomes. Tracks are used to guide which electives you can take and the associated experiential learning experience that is available to you. Regardless of your track, all Strategy majors take the same Junior Core. The purpose of the track options is to guide what electives you choose to take and provide insight on the types of careers a Strategy degree prepares you for. You do not need to officially report your track to the advisement office. You are also free to switch tracks as you progress through the program. However, for the Product and Research tracks, it's helpful for you to decide soon after admission if you want to keep these options open as there are classes you should take your first semester if so.

All tracks are available to Strategy Minors as well, contingent on the associated courses working for their schedule.
