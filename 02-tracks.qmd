...
New students entering the program are part of Business Analyst track by default and a separate application is not required. As part of this track, students will partner with a company to address real strategic issues, gaining hands-on experience and client management skills. This is done Fall or Winter semester of senior year by enrolling in STRAT: 421 Strategy Implementation.

## Product Management Track {.unnumbered}

Students may opt-in to the Product Management track by completing 1 of 3 possible product management experiences, each of which has its own application process and timeline.

The Associate Product Manager (APM) Internship experience is administered by the Strategy program.
 
Sandbox and the Crocker Innovation Fellowship are administered by the Entrepreneurship program. 

Students earn a varying number of credits for each capstone experience which are described below. 

### Associate Product Manager (APM) Internship (3.0-7.0 credits) {.unnumbered}
...
### Sandbox (17.0 credits) {.unnumbered}
