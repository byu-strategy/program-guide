...
<table style="width:100%; text-align: center;">
  <tr>
    <td>
      ...
      <strong>Rachel Wasden</strong><br>
      President<br>
      <a href="mailto:rjwasden@byu.edu">Contact</a>
    </td>
    <td>
      <img src="images/ella.jpeg" alt="Ella Moore" style="border-radius: 50%; width: 150px; height: 150px; object-fit: cover;"><br>
      <strong>Ella Moore</strong><br>
      VP of Events<br>
      <a href="mailto:id214870@byu.edu">Contact</a>
    </td>
    <td>
      <img src="images/cora.jpeg" alt="Cora Montgomery" style="border-radius: 50%; width: 150px; height: 150px; object-fit: cover;"><br>
      <strong>Cora Montgomery</strong><br>
      VP of Marketing<br>
      <a href="mailto:coramo@byu.edu">Contact</a>
    </td>
  </tr>
  <tr>
    <td colspan="3" style="text-align: center;">
      <table style="margin: 0 auto; text-align: center;">
        <tr>
          <td style="padding: 0 2rem;">
            ...
            <strong>Sarah Sun Kanell</strong><br>
            VP of Outreach<br>
            <a href="mailto:sunsarah@byu.edu">Contact</a>
          </td>
          <td style="padding: 0 2rem;">
            <img src="images/jacey.jpeg" alt="Jacey Robins" style="border-radius: 50%; width: 150px; height: 150px; object-fit: cover;"><br>
            <strong>Jacey Robins</strong><br>
            VP of Membership<br>
            <a href="mailto:jaceyrob@byu.edu">Contact</a>
          </td>
        </tr>
      </table>
    </td>
